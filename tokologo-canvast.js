var app = new Vue({
  ...
  data() {
    ...
    return {
      ...
      initials: params.initials || "T",
      initials2: params.initials2 || "G",
      title: params.title || "TOKOLOGO",
      title2: params.title2 || "TOKO",
      title3: params.title3 || "LOGO",
      slogans: params.slogans || "FREE LOGO DESIGN",
  ...
  computed: {
    fill() {
      return this.requestedFill || '#444444';
    },
    fill2() {
